...
const LandPage = () => {
    return (
        <div className='w-auto bg-slate-800'>
            <pre className='text-white text-center text-xl lg:text-4xl font-bold py-8'>WELCOME TO 
                     DREAM CODER</pre>
                     <div className='flex justify-center'>
                       <Link to='/home'><img className='hover:bg-zinc-900 p-2 rounded-md w-20 lg:w-full' src={Arrow} alt="" /></Link>
                     </div>
