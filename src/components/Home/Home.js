...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="">
        <h1 className="title text-center text-teal-600 font-bold text-4xl hover:text-teal-400">Choose your course and achieve your dream..</h1>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-16 lg:grid-cols-3 gap-y-8 gap-x-6 mx-6 mb-24">
        {courses.map((data) => (
